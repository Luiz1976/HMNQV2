...
import { Heart, Trophy, Users, Shield, Lightbulb, ArrowRight, Clock, Target, BarChart3, CheckCircle } from 'lucide-react'
...
const dimensions: Dimension[] = [
  {
    id: 'realizacao',
    name: 'Realização',
    description: 'Foco em resultados e conquistas pessoais',
    icon: Trophy,
    color: 'bg-blue-500'
  },
  {
    id: 'relacionamento',
    name: 'Relacionamento', 
    description: 'Valorização de conexões e trabalho em equipe',
    icon: Users,
    color: 'bg-blue-600'
  },
  {
    id: 'estabilidade',
    name: 'Estabilidade',
    description: 'Busca por segurança e previsibilidade',
    icon: Shield,
    color: 'bg-purple-500'
  },
  {
    id: 'inovacao',
    name: 'Inovação',
    description: 'Abertura para mudanças e novas ideias',
    icon: Lightbulb,
    color: 'bg-orange-500'
  }
]
...
export default function ValoresIntroducao() {
  ...
  const handleStartTest = () => {
    router.push('/colaborador/personalidade/valores?start=true')
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-emerald-800 to-emerald-700 text-white">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          >
            ...
            <div className="bg-emerald-800/30 backdrop-blur-sm rounded-2xl p-8 border border-emerald-600/20">
              ...
              <p className="text-xl text-emerald-100 mb-6">
                Teste de Valores Organizacionais
              </p>
              <p className="text-lg text-emerald-200 max-w-3xl mx-auto leading-relaxed">
                Avaliação científica para identificar valores fundamentais que orientam 
                comportamentos e decisões no ambiente de trabalho
              </p>
            </div>
          </motion.div>
        ...
        <div className="bg-emerald-800/30 backdrop-blur-sm rounded-2xl p-8 border border-emerald-600/20">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-emerald-200 max-w-2xl mx-auto">
              Análise multidimensional dos valores organizacionais com metodologia científica avançada
            </p>
          </div>
        ...
        >
          ...
          <div>
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
              <Heart className="w-6 h-6 mr-3 text-emerald-300" />
              O que é o HumaniQ VALORES?
            </h3>
            <p className="text-emerald-200 text-sm leading-relaxed mb-4">
              O Teste de Valores e Motivações VALORES é um instrumento 
              psicométrico desenvolvido para identificar e mensurar os valores 
              fundamentais que orientam comportamentos e decisões no contexto 
              organizacional.
            </p>
            <p className="text-blue-200 text-sm leading-relaxed mb-4">
              Baseado em teorias consolidadas da psicologia organizacional, 
              o teste avalia quatro dimensões principais de valores que 
              influenciam diretamente o desempenho e a satisfação profissional.
            </p>
            <p className="text-blue-200 text-sm leading-relaxed">
              Esta avaliação oferece insights valiosos para desenvolvimento 
              pessoal, alinhamento organizacional e tomada de decisões 
              conscientes no ambiente de trabalho.
            </p>
          </div>
        </motion.div>
