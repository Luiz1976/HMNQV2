...
export default function FLEXIntroducaoPage() {
  ...
  const handleStartTest = async () => {
    ...
    try {
      ...
      localStorage.setItem('flex_intro_viewed', 'true')
      
      // Redirecionar para o teste
      router.push('/colaborador/personalidade/flex')
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-emerald-200 mb-8 max-w-4xl mx-auto">
            Avaliação científica de última geração para mensurar capacidades de adaptabilidade com precisão excepcional e insights acionáveis.
          </p>
            ...
            <div className="flex justify-center">
              <div className="w-80 h-80 bg-gradient-to-br from-emerald-700/40 to-emerald-800/40 rounded-full flex items-center justify-center border-4 border-emerald-500/30 backdrop-blur-sm relative overflow-hidden">
                ...
                <div className="text-center relative z-10">
                  ...
                  <div className="text-4xl font-bold text-white mb-2">FLEX</div>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-emerald-100">
                  <div className="flex items-center space-x-3 p-3 bg-emerald-700/20 rounded-lg">
                    ...
                    <span>O que é o HumaniQ FLEX – Avaliação de Adaptabilidade?</span>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-emerald-700/20 rounded-lg">
                    <CheckCircle className="h-5 w-5 text-emerald-400 flex-shrink-0" />
            ...
            <Card className="bg-emerald-800/20 border-emerald-600/30 backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-white">O que é o HumaniQ FLEX – Avaliação de Adaptabilidade?</h3>
                </div>
                <div className="space-y-4 text-emerald-100">
                  <p>
                    A Avaliação de Adaptabilidade (FLEX) é um instrumento psicométrico desenvolvido para 
                    avaliar as capacidades cognitivas fundamentais relacionadas à flexibilidade mental e 
                    adaptabilidade cognitiva.
                  </p>
                  <p>
                    Baseado em décadas de pesquisa em psicologia cognitiva, o FLEX mensura a capacidade de 
                    alternar entre diferentes tarefas e adaptar-se a mudanças de contexto de forma eficiente.
                  </p>
                  <p>
                    Este teste é amplamente utilizado em contextos organizacionais para identificar profissionais 
                    com alta capacidade de adaptação e flexibilidade mental.
                  </p>
                </div>
              </CardContent>
            </Card>
